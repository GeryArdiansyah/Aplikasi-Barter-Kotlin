...
import com.bartas.aplikasibarter.databinding.ActivitySearchPerabotanBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*
import java.util.*

class PerabotanActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySearchPerabotanBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySearchPerabotanBinding.inflate(layoutInflater)
        ...
        val gridLayoutManager = GridLayoutManager(this@PerabotanActivity, 2)
        binding.recyclerView.layoutManager = gridLayoutManager
        binding.searchView.clearFocus()
        val builder = AlertDialog.Builder(this@PerabotanActivity)
        ...
        dataList = ArrayList()
        adapter = MyAdapterKategori(this@PerabotanActivity, dataList, databaseReference)
        ...
        eventListener = databaseReference!!.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (itemSnapshot in snapshot.children) {
                    ...
                    if (dataClass?.kategori == "Perabotan") {
