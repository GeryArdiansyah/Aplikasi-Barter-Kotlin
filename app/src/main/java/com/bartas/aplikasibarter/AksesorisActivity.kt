...
import com.bartas.aplikasibarter.databinding.ActivitySearchAksesorisBinding
...
class AksesorisActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySearchAksesorisBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySearchAksesorisBinding.inflate(layoutInflater)
        ...
        val gridLayoutManager = GridLayoutManager(this@AksesorisActivity, 2)
        binding.recyclerView.layoutManager = gridLayoutManager
        binding.searchView.clearFocus()
        val builder = AlertDialog.Builder(this@AksesorisActivity)
        ...
        dataList = ArrayList()
        adapter = MyAdapterKategori(this@AksesorisActivity, dataList, databaseReference)
        ...
        eventListener = databaseReference!!.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (itemSnapshot in snapshot.children) {
                    ...
                    if (dataClass?.kategori == "Aksesoris") {
