...
import com.bartas.aplikasibarter.databinding.ActivitySearchElektronikBinding
...
class ElektronikActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivitySearchElektronikBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySearchElektronikBinding.inflate(layoutInflater)
        ...
        val gridLayoutManager = GridLayoutManager(this@ElektronikActivity, 2)
        binding.recyclerView.layoutManager = gridLayoutManager
        binding.searchView.clearFocus()
        val builder = AlertDialog.Builder(this@ElektronikActivity)
        ...
        dialog.show()
        dataList = ArrayList()
        adapter = MyAdapterKategori(this@ElektronikActivity, dataList, databaseReference)
        ...
        eventListener = databaseReference!!.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (itemSnapshot in snapshot.children) {
                    ...
                    if (dataClass?.kategori == "Elektronik") {
